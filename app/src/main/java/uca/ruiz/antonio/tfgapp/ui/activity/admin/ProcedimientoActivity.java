...
public class ProcedimientoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_1_2.setText(procedimiento.getCodigo());

        tv_2_1.setText(getString(R.string.nombre));
        tv_2_2.setText(procedimiento.getNombre());
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_editar:
                Intent intent = new Intent(this, ProcedimientoNewEditActivity.class);
