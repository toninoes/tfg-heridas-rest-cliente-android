...
import uca.ruiz.antonio.tfgapp.ui.activity.admin.SalaActivity;
...
public class SalaAdapter extends RecyclerView.Adapter<SalaAdapter.ViewHolder> {
    ...
    private ArrayList<Sala> mDataSet;
    ...
    public void setDataSet(ArrayList<Sala> dataSet) {
        mDataSet = dataSet;
    ...
    @Override
    public SalaAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Sala sala = mDataSet.get(position);
        holder.tv_titulo.setText(sala.getNombre());
        holder.tv_subtitulo.setText(sala.getCentro().getNombre());
        ...
        holder.ib_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int pos = holder.getAdapterPosition();
                Sala sala = mDataSet.get(pos);
                Intent intent = new Intent(context, SalaNewEditActivity.class);
                intent.putExtra("sala", sala);
                context.startActivity(intent);
            }
        });
    ...
    private void borrarSala(final long id, final int pos) {
        Call<String> call = MyApiAdapter.getApiService().borrarSala(id, Pref.getToken());
