...
import uca.ruiz.antonio.tfgapp.ui.activity.admin.AdministradorActivity;
import uca.ruiz.antonio.tfgapp.ui.activity.admin.AdministradorNewEditActivity;
import uca.ruiz.antonio.tfgapp.utils.Pref;

import static android.content.ContentValues.TAG;


public class AdministradorAdapter extends RecyclerView.Adapter<AdministradorAdapter.ViewHolder> {

    private ArrayList<Administrador> mDataSet;
    ...
    public AdministradorAdapter(Context context) {
        this.context = context;
        mDataSet = new ArrayList<>();
    }

    public void setDataSet(ArrayList<Administrador> dataSet) {
        mDataSet = dataSet;
    ...
    @Override
    public AdministradorAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Administrador administrador = mDataSet.get(position);
        holder.tv_titulo.setText(administrador.getLastnameComaAndFirstname());
        holder.tv_subtitulo.setText(administrador.getDni());
        ...
        holder.ll_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Administrador administrador = mDataSet.get(pos);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch(which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                int pos = holder.getAdapterPosition();
                                Administrador administrador = mDataSet.get(pos);
                                borrarAdministrador(administrador.getId(), pos);
                                break;
        ...
        holder.ib_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int pos = holder.getAdapterPosition();
                Administrador administrador = mDataSet.get(pos);
                Intent intent = new Intent(context, AdministradorNewEditActivity.class);
                intent.putExtra("administrador", administrador);
                context.startActivity(intent);
            }
        });
    ...
    private void borrarAdministrador(final long id, final int pos) {
        Call<String> call = MyApiAdapter.getApiService().borrarAdministrador(id, Pref.getToken());
