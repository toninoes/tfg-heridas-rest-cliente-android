...
import uca.ruiz.antonio.tfgapp.ui.activity.admin.SanitarioActivity;
...
public class SanitarioAdapter extends RecyclerView.Adapter<SanitarioAdapter.ViewHolder> {

    private ArrayList<Sanitario> mDataSet;
    ...
    public SanitarioAdapter(Context context) {
        this.context = context;
        mDataSet = new ArrayList<>();
    }

    public void setDataSet(ArrayList<Sanitario> dataSet) {
        mDataSet = dataSet;
    ...
    @Override
    public SanitarioAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Sanitario sanitario = mDataSet.get(position);
        holder.tv_titulo.setText(sanitario.getLastnameComaAndFirstname());
        holder.tv_subtitulo.setText(sanitario.getDni());
        ...
        holder.ll_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Sanitario sanitario = mDataSet.get(pos);
                Intent intent = new Intent(context, SanitarioActivity.class);
                intent.putExtra("sanitario", sanitario);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch(which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                int pos = holder.getAdapterPosition();
                                Sanitario sanitario = mDataSet.get(pos);
                                borrarSanitario(sanitario.getId(), pos);
                                break;
        ...
        holder.ib_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int pos = holder.getAdapterPosition();
                Sanitario sanitario = mDataSet.get(pos);
                Intent intent = new Intent(context, SanitarioNewEditActivity.class);
                intent.putExtra("sanitario", sanitario);
                context.startActivity(intent);
            }
        });
    ...
    private void borrarSanitario(final long id, final int pos) {
        Call<String> call = MyApiAdapter.getApiService().borrarSanitario(id, Pref.getToken());
