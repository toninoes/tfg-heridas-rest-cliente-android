...
public class PacienteAdapter extends RecyclerView.Adapter<PacienteAdapter.ViewHolder> {
    ...
    public void setDataSet(ArrayList<Paciente> dataSet) {
        mDataSet = dataSet;
    ...
    @Override
    public PacienteAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Paciente paciente = mDataSet.get(position);
        holder.tv_titulo.setText(paciente.getLastnameComaAndFirstname());
        holder.tv_subtitulo.setText(paciente.getDni());
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch(which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                int pos = holder.getAdapterPosition();
                                Paciente paciente = mDataSet.get(pos);
                                borrarPaciente(paciente.getId(), pos);
                                break;
    ...
    private void borrarPaciente(final long id, final int pos) {
        Call<String> call = MyApiAdapter.getApiService().borrarPaciente(id, Pref.getToken());
