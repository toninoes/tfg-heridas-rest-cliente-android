...
public class GrupodiagnosticoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_1_2.setText(grupodiagnostico.getNombre());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_editar:
                Intent intent = new Intent(this, GrupodiagnosticoNewEditActivity.class);
