...
public class CentroAdapter extends RecyclerView.Adapter<CentroAdapter.ViewHolder> {
    ...
    @Override
    public CentroAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.ib_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int pos = holder.getAdapterPosition();
                Centro centro = mDataSet.get(pos);
                Intent intent = new Intent(context, CentroNewEditActivity.class);
                intent.putExtra("centro", centro);
                context.startActivity(intent);
            }
        });
    ...
    private void borrarCentro(final long id, final int pos) {
        Call<String> call = MyApiAdapter.getApiService().borrarCentro(id, Pref.getToken());
