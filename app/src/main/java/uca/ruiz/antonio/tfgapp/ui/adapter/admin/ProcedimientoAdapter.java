...
import uca.ruiz.antonio.tfgapp.ui.activity.admin.ProcedimientoActivity;
import uca.ruiz.antonio.tfgapp.ui.activity.admin.ProcedimientoNewEditActivity;
import uca.ruiz.antonio.tfgapp.utils.Pref;

import static android.content.ContentValues.TAG;


public class ProcedimientoAdapter extends RecyclerView.Adapter<ProcedimientoAdapter.ViewHolder> {

    private ArrayList<Procedimiento> mDataSet;
    ...
    public ProcedimientoAdapter(Context context) {
        this.context = context;
        mDataSet = new ArrayList<>();
    }

    public void setDataSet(ArrayList<Procedimiento> dataSet) {
        mDataSet = dataSet;
    ...
    @Override
    public ProcedimientoAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Procedimiento procedimiento = mDataSet.get(position);
        holder.tv_titulo.setText(procedimiento.getNombre());
        holder.tv_subtitulo.setText(procedimiento.getCodigo());
        ...
        holder.ll_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Procedimiento procedimiento = mDataSet.get(pos);
                Intent intent = new Intent(context, ProcedimientoActivity.class);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch(which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                int pos = holder.getAdapterPosition();
                                Procedimiento procedimiento = mDataSet.get(pos);
                                borrarProcedimiento(procedimiento.getId(), pos);
                                break;
        ...
        holder.ib_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int pos = holder.getAdapterPosition();
                Procedimiento procedimiento = mDataSet.get(pos);
                Intent intent = new Intent(context, ProcedimientoNewEditActivity.class);
                intent.putExtra("procedimiento", procedimiento);
                context.startActivity(intent);
            }
        });
    ...
    private void borrarProcedimiento(final long id, final int pos) {
        Call<String> call = MyApiAdapter.getApiService().borrarProcedimiento(id, Pref.getToken());
