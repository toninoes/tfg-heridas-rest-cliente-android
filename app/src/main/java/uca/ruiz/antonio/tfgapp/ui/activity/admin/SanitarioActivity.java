...
public class SanitarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_1_2.setText(sanitario.getFirstname());

        tv_2_1.setText(R.string.apellidos);
        tv_2_2.setText(sanitario.getLastname());

        tv_3_1.setText(R.string.dni);
        tv_3_2.setText(sanitario.getDni());

        tv_4_1.setText(R.string.email);
        tv_4_2.setText(sanitario.getEmail());
        ...
        tv_6_2.setText(FechaHoraUtils.getNacimientoAndEdad(sanitario.getNacimiento()));

        tv_7_1.setText(R.string.colegiado);
        tv_7_2.setText(sanitario.getColegiado());

        tv_8_1.setText(R.string.centro);
        tv_8_2.setText(sanitario.getCentroActual().getNombre());
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_editar:
                Intent intent = new Intent(this, SanitarioNewEditActivity.class);
